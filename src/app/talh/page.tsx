...
export default function TalhPage() {
  const products = PRODUCTS.filter((p) => p.category === "Талх");
  ...
  return (
    <div className="min-h-full bg-bg">
      ...
      >
        <div className="mx-auto max-w-5xl">
          <div className="flex items-center gap-3">
            <Bread size={32} weight="fill" className="text-primary" />
            <h1 className="font-heading text-2xl text-ink">Талх</h1>
          </div>
          <p className="mt-2 text-sm leading-relaxed text-muted">
            Өдөр бүр шинэхэн, гар аргаар хийсэн уламжлалт ба франц талхны төрөл бүрэн.
          </p>
        </div>
      </motion.section>
      ...
      {products.length > 0 ? (
        ...
        >
          <Bread size={48} weight="thin" className="text-border" />
